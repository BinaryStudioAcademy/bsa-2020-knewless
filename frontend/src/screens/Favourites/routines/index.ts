...
export const fetchFavouriteArticlesRoutine = createRoutine('FETCH_FAVOURITE_ARTICLES');
...
export const removeArticleFavouriteRoutine = createRoutine('ARTICLE_FAVOURITE_REMOVE');
