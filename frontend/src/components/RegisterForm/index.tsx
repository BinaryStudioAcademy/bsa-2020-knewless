        ...
        >
          <Segment className={styles.main_container__form}>
            ...
            <Message
              warning
              list={[
                !isPasswordValid && 'Password should be at least 8 characters and contain one low, upper letter, '
            ...
            <div className={styles.main_container__submit_block}>
              <GradientButton
                ...
                disabled={!isEmailValid || !isPasswordEqual || !isPasswordValid}
              >
                SIGN UP
              </GradientButton>
