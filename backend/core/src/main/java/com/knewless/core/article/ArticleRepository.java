...
@Repository
public interface ArticleRepository extends CommentSourceRepository<Article>, JpaRepository<Article, UUID> {
    ...
    @Override
    default Optional<Article> findSourceById(UUID sourceId) {
