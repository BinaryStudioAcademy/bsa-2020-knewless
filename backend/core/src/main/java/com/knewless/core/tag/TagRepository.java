...
public interface TagRepository extends JpaRepository<Tag, UUID> {
    ...
    List<String> getTagsNamesByCourseId(UUID id);

    @Query("SELECT DISTINCT t FROM Course c LEFT JOIN c.lectures as l LEFT JOIN l.tags as t WHERE c.id = :id")
    List<Tag> getTagsByCourseId(UUID id);
